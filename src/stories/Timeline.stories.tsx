...
import { createTimelineController } from '../store/TimelineController'
  ...
  render: () => {
    ...
    return (
      <div>
          ...
          <TimelineRow height={40} align="top" style={{ borderTop: '1px solid #ccc' }}>
            <TimelinePattern
              ...
              renderAt={(ts, zm) => {
                ...
                if (m.minutes() === 0 && zm > 1.1) return <ScaleHour text={m.format('H')} />
                return <ScaleQuarter />
              }}
            />
          </TimelineRow>
        ...
        <button
          onClick={() => {
            controller.fitTimeRange('12:00:00', '14:30:00')
          }}
        >
          FIT
        </button>
